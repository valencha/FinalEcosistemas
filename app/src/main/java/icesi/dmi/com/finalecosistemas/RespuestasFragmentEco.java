...
public class RespuestasFragmentEco extends Fragment{
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.respuestaeco, container, false);
        ...
        Query respuestas= reference.child("usuarios").child("respuestasEco");
        ...
        listAdapter = new FirebaseListAdapter<Respuesta>(options) {
            ...
            protected void populateView(@NonNull View v, @NonNull Respuesta model, final int position) {
                ...
                listAdapter.getRef(position).child("puntuaResEco").addValueEventListener(new ValueEventListener() {
                    @Override
